...
const AboutMe = () => {
  return (
    <div className='flex-[0.65] w-full bg-gray-700 relative'>
      <p className='text-[36px] text-white text-center pt-16 mt-8 font-body text-transform capitalize'>every successful journey begins with </p>
      ...
      <p className='text-[1rem] text-gray-500 text-center pt-16 font-body leading-8'>
      ...
      <button className='bg-[#009D66] py-2 px-4 text-white font-body rounded-md download-inner-shadow border-[#009D66] absolute border-t-[1px] left-[50%] transform translate-x-[-50%]'>Download Cv</button>
