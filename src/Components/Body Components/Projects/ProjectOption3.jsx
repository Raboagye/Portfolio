...
const ProjectOption3 = ({HandleProject, activeScroll}) => {
  ...
  return (
    <div 
     className=' flex-[1] md:flex-[0.9] mid:flex-[0.65] w-full pb-60 md:pb-80 mdium:h-[100vh] mdium:pb-0 relative perspective-1000 mt-16 flex flex-col items-center mdium:items-start mdium:pl-16 lg:pl-0'>
          ...
          className='w-[90%] mdium:w-[43%] top-80 flex flex-col items-center absolute md:top-96  mdium:left-8 pt-4 md:mt-16'>
              <p className='text-[20px] hover:text-white text-center pt-8 font-body text-sm md:text-sm lg:text-[1rem] cursor-pointer text-[#099D66]' onClick={()=>openLink("https://yts.mx")}>Musix: A Music App</p>
              <div>
