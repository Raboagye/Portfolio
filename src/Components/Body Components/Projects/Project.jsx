...
const Project = () => {
  return (
    <div className='container flex-[0.65] w-full bg-gray-700 flex flex-col h-[100vh] relative perspective-1000 mt-16'>
          <div className='group w-[400px] h-[400px]'>
              <div className='w-[250px] justify-center items-center h-[250px] transform-style-3d moveAnimate group mt-20'>
          ...
          <div className='w-[43%] flex flex-col  absolute right-0 pt-4 mt-96'>
