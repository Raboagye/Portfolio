              ...
              </motion.div>
              {
                  showNav && (
                      <motion.div variants={stagger2} className='absolute w-[20%] min-w-[130px] bg-gray-700  rounded-lg top-[58px] right-0 z-[999] flex flex-col gap-[3px] lg:hidden dark:bg-black transition-all duration-500' >
                          <motion.div variants={header2} className={`${activeHome? 'bg-[#009D66] text-white': 'bg-gray-400 text-gray-400'}  inner-shadow  border-t-[1px] text-center rounded-md py-0 px-4 hover:bg-[#009d6620] hover:border-[#009D66] cursor-pointer relative  group`}onClick={HandleHome} >
                          ...
                          <motion.div variants={header2} className={`${activeAbout? 'bg-[#009D66] text-white': 'bg-gray-400 text-gray-400'} inner-shadow border-t-[1px] text-center border-gray-500 rounded-md py-0 px-4 hover:bg-[#009d6620] hover:border-[#009D66] cursor-pointer relative group`} onClick={HandleAbout}>
                          ...
                          <motion.div variants={header2} className={`${activeSkills? 'bg-[#009D66] text-white': 'bg-gray-400 text-gray-400'} inner-shadow border-t-[1px] text-center border-gray-500 rounded-md py-0 px-4 hover:bg-[#009d6620] hover:border-[#009D66] cursor-pointer relative group`}onClick={HandleSkills}>
                          ...
                          <motion.div variants={header2} className={`${activeProjects? 'bg-[#009D66] text-white': 'bg-gray-400 text-gray-400'} inner-shadow border-t-[1px] text-center border-gray-500 rounded-md py-0 px-4 hover:bg-[#009d6600] hover:border-[#009D66] cursor-pointer relative group`} onClick={HandleProject}>
                          ...
                          <motion.div variants={header2} className={`${activeContact? 'bg-[#009D66] text-white': 'bg-gray-400 text-gray-400'} inner-shadow border-t-[1px] text-center border-gray-500 rounded-md py-0 px-4 hover:bg-[#009d6620] hover:border-[#009D66] cursor-pointer relative group`} onClick={HandleContact}>
